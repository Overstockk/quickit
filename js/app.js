(() => {
    ...
    function initSliders() {
        if (document.querySelector(".built__slider")) new swiper_core_Swiper(".built__slider", {
            modules: [Pagination],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            pagination: {
                el: ".built__pagination",
                clickable: true
            },
            on: {}
        });
        if (document.querySelector(".quickit__slider")) new swiper_core_Swiper(".quickit__slider", {
    ...
    da.init();
    const layoutsStars = document.querySelectorAll(".img-layouts__red-star");
    const benefitsStars = document.querySelectorAll(".img-benefits__star");
    function addScaleAnimationClass(arr) {
        for (let i = 0; i < arr.length; i++) {
            const element = arr[i];
            if (!element.classList.contains("star-big")) setTimeout((() => {
                element.classList.add("_scale-animation");
            }), i * 200);
        }
    }
    addScaleAnimationClass(layoutsStars);
    addScaleAnimationClass(benefitsStars);
